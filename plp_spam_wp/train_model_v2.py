...
def save_log():
    ...
    with open(LOG_FILE, 'w', encoding='utf-8') as f:
        f.write("# YouTube Spam Detection Model Training Log (MultinomialNB)\n\n")
...
# Train model
log_message("Training MultinomialNB model...")
model = MultinomialNB()
...
log_message("Model and vectorizer saved to 'spam_model_v2.pkl' and 'vectorizer_v2.pkl'")
