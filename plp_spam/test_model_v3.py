...
def save_log():
    ...
    with open(LOG_FILE, 'w', encoding='utf-8') as f:
        f.write("# YouTube Comment Analysis Log (LogisticRegression Model)\n\n")
...
def load_model_and_vectorizer():
    ...
    try:
        ...
        log_message("Error: Model files not found. Please run train_model_v3.py first to train the model.")
        return None, None
    except Exception as e:
...
def main():
    ...
    if not os.path.exists('spam_model_v3.pkl') or not os.path.exists('vectorizer_v3.pkl'):
        log_message("Error: Model files not found. Please run train_model_v3.py first to train the model.")
        save_log()
        return
    ...
    output_csv_path = 'comments_analysis_v3.csv'
